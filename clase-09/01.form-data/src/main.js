...
formulario.addEventListener('submit', async e => {
   ...
   /*  for (const [key, value] of datos) {
    ...
    try {
        const objetoJsApartirDelFormData = Object.fromEntries(datos.entries());
        ...
        const options = {
            ...
            body: JSON.stringify(objetoJsApartirDelFormData) // Objeto de js se pasa a una cadena (json)
        }
