...
console.warn('// Leo los datos del storage')
...
console.warn('// Eliminar elementos')
...
/* const numeros = [2,3,4] // 3
console.log(numeros) // 3 -> despligue -> 1
numeros.pop()
console.log(numeros) // 2
numeros.pop() 
console.log(numeros) // 1  */

console.warn('Limpia todo el storage')

//localStorage.clear()

// ! SessionStorage
// Se gestiona todo igual al localStorage. La diferencia con localStorage es que SessionStorage no persiste la informaicón si la pestaña o el navgador es cerrado
